    ...
    with st.container(border=True):
        st.markdown("**Background:**<br>"
                     "According to data from [SIPONGI KLHK](%s)" % urlsipongi + " and [FIRMS NASA](%s)" % urlfirms + " "
                                                                                                           "October 2023, in the :blue[South Sumatra Province] which has a population of 8.6 million people (BPS 2022),"
                                                                                                           "and has a developing metropolitan area, namely Paturaya Agung, which has a population of 2.6 million people (BPS 2020),"
                                                                                                           "notably :blue[Palembang City with a population of around 1.7 million people] (BPS 2022)."
                                                                                                           "There are :blue[most] hotspots of Land Forest Fire Disaster incidents compared to other provinces in Indonesia, which are aggravated by the El Nino phenomenon. <br>"
                                                                                                           "**Analysis Focus:**<br>"
                                                                                                           "The author focuses on conducting analysis in Palembang City, not only because the most populous area in South Sumatra Province, "
                                                                                                          "but also because of data such as temperature and precipitation,"
                                                                                                           " and wind speed were obtained from BMKG, whose stations and measurement accuracy are located around that city."
                                                                                                           "The focus of the analysis is also on month of October, which is the peak of the 2023 El Nino season.<br>"
