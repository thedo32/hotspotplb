    ...
    with st.container(border=True):
        st.markdown("**Background:**<br>"
                     "According to data from [SIPONGI KLHK](%s)" % urlsipongi + " and [FIRMS NASA](%s)" % urlfirms + " "
                                                                                                           "October 2023, in the :blue[South Sumatra Province] which has a population of 8.6 million people (BPS/Statistics of Indonesia 2022),"
                                                                                                           "and has a developing metropolitan area, namely Paturaya Agung, which has a population of 2.6 million people (BPS/Statistics of Indonesia 2020),"
                                                                                                           "notably :blue[Palembang City with a population of around 1.7 million people] (BPS/Statistics of Indonesia 2022)."
